...
| Dataset | Model              | Neuron      | Rec. | Delays      | Param | Seeds | Test Acc. [%] |
|---------|--------------------|-------------|------|-------------|-------|-------|---------------|
...
| SSC     | DelRec (ours)      | LIF         | yes  | Rec. (ax.)  | 0.37M | 5     | 82.42+/-0.23  |
...
| PSMNIST | DelRec (ours)      | LIF         | yes  | Rec. (syn.) | 0.25M | 5     | 96.63+/-0.12  |
