"""Vendored SpikingJelly Spiking Heidelberg Digits downloader, with fixes.

Kept in-tree because the released SpikingJelly version of this loader had bugs. This is the development version plus corrections. Used only by the SHD appendix.
"""
...
'Code comming from the latest developer version of SpikingJelly library, with a few bug fixes since the last stable version which is used in this project'
...
class SpikingHeidelbergDigits(Dataset):
    def __init__(
        ...
        """The Spiking Heidelberg Digits (SHD) dataset, which is proposed by `The Heidelberg
        Spiking Data Sets for the Systematic Evaluation of Spiking Neural Networks
        <https://doi.org/10.1109/TNNLS.2020.3044364>`_. Refer to
        :class:`spikingjelly.datasets.NeuromorphicDatasetFolder` for more details about params
        information.
        """
        super().__init__()
        self.root = root
    ...
    def extract_downloaded_files(download_root: str, extract_root: str):
        """:param download_root: Root directory path which saves downloaded dataset files :type
        download_root: str :param extract_root: Root directory path which saves extracted files
        from downloaded files :type extract_root: str :return: None This function defines how
        to extract download files.
        """
